    ...
    return (
        ...
        <div className="hero-content flex-col lg:flex-row-reverse w-full">
            <div className="card flex-shrink-0 w-full max-w-sm shadow-2xl bg-base-100 p-5">
                <h1 className='text-center text-pink-600 font-bold text-2xl'>Please Register</h1>
                <form onSubmit={handleSubmit}>
                    <div className="card-body">
                        ...
                        <div className="form-control">
                            ...
                            <label className="label">
                                <p className="label-text-alt link link-hover font-bold">Already have an account? <Link to='/login' className='text-pink-600'>Please Login</Link></p>
                            </label>

                        </div>

                        <div className="form-control mt-6">
                            <button className="btn bg-pink-600 border-0">Register</button>
                        </div>
                    </div>
                </form>
