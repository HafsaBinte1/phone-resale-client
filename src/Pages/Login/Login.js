        ...
        <div className="hero min-h-screen ">
            <div className="hero-content flex-col lg:flex-row-reverse w-full">
                <div className="card flex-shrink-0 w-full max-w-sm shadow-2xl bg-base-100 p-5">
                    <h1 className='text-center text-pink-600 font-bold text-2xl'>Please Login</h1>
                    <div className="card-body">
                        ...
                        <div className="form-control">
                            ...
                            <label className="label">
                                <p className="label-text-alt link link-hover font-bold">New in Phone world? <Link to='/register' className='text-pink-600'>Please Resister</Link></p>
                            </label>
                        </div>
