...
const BookingModal = ({ carName, setCarName }) => {
    const { brand, phone_name, orginal_price, resale_price } = carName
    ...
    const handleBooking = event => {
        ...
        fetch('https://phone-resale-server-three.vercel.app/bookings', {
            method: 'POST',
            headers: {
            ...
            <div className="modal">
                <div className="modal-box relative">
                    ...
                    <form onSubmit={handleBooking} className='grid grid-cols-1 gap-5 mt-6'>
                        ...
                        <br />
                        <input className='w-full btn bg-pink-600 border-0' type="submit" value="Submit" />
                    </form>
                </div>
            </div>
        </>
