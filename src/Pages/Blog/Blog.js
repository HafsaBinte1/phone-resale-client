...
const Blog = () => {
    return (
        <div className='py-20'>
            <h1 className='text-center'><span className='text-pink-600 font-bold text-4xl'>Phone world </span>    <span className='font-bold text-xl'>Blogs you can know our services from here...</span></h1>
            <div className='pt-10'>
